module.exports = (plop) => {
  plop.setGenerator('base', {
    ...
    actions: [
      {
        type: 'add',
        path: 'src/components/base/{{pascalCase name}}/{{pascalCase name}}.css',
        templateFile: 'generators/base/base.css.hbs',
      },
      {
        type: 'add',
      ...
      {
        type: 'append',
        path: 'src/components/base/index.tsx',
    ...
    actions: [
      {
        type: 'add',
        path:
          'src/components/layout/{{pascalCase name}}/{{pascalCase name}}.tsx',
